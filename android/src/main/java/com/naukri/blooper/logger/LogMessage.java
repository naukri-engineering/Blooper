package com.naukri.blooper.logger;

public interface LogMessage
{
    String DATABASE_INIT = "Database initialization complete";
    String BLOOPER_SDK_INIT = "Blooper Sdk initialization complete";
    String BLOOPER_SDK_REINIT = "Blooper already initialized. Nothing to do";
    String EXCEPTION_HANDLER_INIT = "Exception Handler initialization complete";
    String ERROR_INIT_BLOOPER_SDK = "Initialize New Blooper First";
    ...
    String BLOOPER_START_BOOT_COMPLETE = "Blooper Sdk Start After Boot Complete";
    ...
    String NO_ANNOTATION = "BlooperCrashReport annotation missing";
